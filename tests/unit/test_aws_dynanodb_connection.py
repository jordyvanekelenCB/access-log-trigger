...
from LambdaCode.models.alb_client import ALBClient
...
def test_insert_into_queue(get_mock_config):
    ...
    # !ARRANGE!
    alb_client_1 = ALBClient('1.1.1.1', 1001, HTTPFlood.HTTPFloodLevel.flood_level_low)
    alb_client_2 = ALBClient('2.2.2.2', 5001, HTTPFlood.HTTPFloodLevel.flood_level_medium)
    alb_client_3 = ALBClient('3.3.3.3', 10001, HTTPFlood.HTTPFloodLevel.flood_level_critical)
